...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ProcessData_t, stringdata) + ofs \
...
const QMetaObject ProcessData::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ProcessData.data,
      qt_meta_data_ProcessData,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ProcessData::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ProcessData.stringdata))
        return static_cast<void*>(const_cast< ProcessData*>(this));
